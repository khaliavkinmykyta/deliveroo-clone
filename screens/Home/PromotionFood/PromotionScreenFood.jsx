...
import FoodPromotionRow from "../../../components/FoodRowPromotion";

const PromotionScreenFood = () => {
  ...
  return (
    <SafeAreaView className="bg-white flex-1">
      ...
      {/* NAME OF CATEGORY */}
      <Text className="font-bold text-2xl my-2 text-center">Promotion</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <FoodPromotionRow item={item} key={item.unicId} test={item.uid} />
        )}
      />
    </SafeAreaView>
  );
...
export default PromotionScreenFood;
